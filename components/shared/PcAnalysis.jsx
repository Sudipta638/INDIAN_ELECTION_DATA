...
const PcAnalysis = () => {
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    fetch(
      `http://localhost:8000/api/winner_latest_year/${selectedState}/${selectedPc}`
    )
      .then((response) => response.json())
      .then((data) => {
    ...
    fetch(
      `http://localhost:8000/api/VotePercentageinApcPCyearwise/${selectedState}/${selectedPc}`
    )
      .then((response) => response.json())
      .then((data) => {
    ...
    fetch(
      `http://localhost:8000/api/FemaleandMaleRationinApcPCyearwise/${selectedState}/${selectedPc}`
    )
      .then((response) => response.json())
      .then((data) => {
        ...
        <div>
          ...
          <div className={issearching?"hidden":`flex justify-between items-center -mt-16  ml-[300px]`}>
            ...
            <div className="w-[500px] flex items-center  mr-[300px]">
              <label className="mr-4 w-[170px] text-2xl">PC Name:</label>
              <select
                value={selectedPc}
              ...
              >
                <option value="">Select an PC name</option>
              ...
              <div className="flex w-[1800px] ml-48 -mr-44 -mt-32">
                ...
                <div className="w-1/2">
                  <div className="p-4  shadow-lg m-16 mt-36">
                    <Tables pcname={selectedPc} stname={selectedState} />
                  </div>
                </div>
              </div>
